  ...
  <div>
    ...
    <UiModal ref="modal" title="Login">
      <div v-if="!value" class="default-margin dropdown-reposition">
        ...
        />
        <UiButton :disabled="!formValid" color="primary" @click="login">
          Login
        </UiButton>
        Don't have an account yet?
        <UiButton :disabled="!formValid" @click="register"> Register </UiButton>
      </div>
      <div v-else><UiButton @click="logout"> Logout </UiButton></div>
    </UiModal>
  </div>
</template>
